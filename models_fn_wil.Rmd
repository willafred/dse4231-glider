...
models = c('rlasso','saturated','glider','adaptive_lasso','madr')
num_sim = 1000
num_params = 5
...
for (model_name in models){
  ...
  model_df = mc_simulation_parallel(model_df_func, num_params = num_params, num_params_scene10 = num_params_scene10, total_sim = 1000)
