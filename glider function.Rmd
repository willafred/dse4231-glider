...
This file details the process of generation of the GLiDeR function from the paper. This file can has 2 main chunks to note:

(1) Functions involved to run the GLiDeR function is detailed in this chunk. Running this chunk is necessary to run the sample use case
(2) A sample use case of GLiDeR is included

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
```

## Functions Used in GLiDeR (can just run as one whole chunk to run GLiDeR)
...
# Sample Chunk (with sample simulated data)
```{r}
...
#Generate probability that A = 1 given covariates --> treatment
